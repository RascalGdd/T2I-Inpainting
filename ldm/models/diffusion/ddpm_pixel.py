...
class LatentDiffusion(DDPM):
    ...
    def p_losses(self, x_start, cond, t, noise=None, **kwargs):
        ...
        cv2.imwrite('/cluster/scratch/denfan/inpainting_stable/test_img_one/output_'+filename+'.jpg', model_output)
        # crop
        ...
        cv2.imwrite('/cluster/scratch/denfan/inpainting_stable/test_img_one/gt_blurred_'+filename+'.jpg', gt_blurred) 
        ...
        cv2.imwrite('/cluster/scratch/denfan/inpainting_stable/test_img_one/output_blurred_'+filename+'.jpg', model_output_blurred)
